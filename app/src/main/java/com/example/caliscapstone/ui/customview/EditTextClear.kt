package com.example.caliscapstone.ui.customview
...
class EditTextClear : AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            setTextColor(ContextCompat.getColor(this, R.color.palette17))
            setHintTextColor(ContextCompat.getColor(this, R.color.palette17))
        }
        isSingleLine = true
