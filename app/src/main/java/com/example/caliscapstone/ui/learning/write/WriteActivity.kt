package com.example.caliscapstone.ui.learning.write

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.ImageView
import com.example.caliscapstone.HomeActivity
import com.example.caliscapstone.R
import com.example.caliscapstone.ui.learning.write.level.WriteDasar
import com.example.caliscapstone.ui.learning.write.level.WriteLanjut
import com.example.caliscapstone.ui.learning.write.level.WriteMenengah
...
class WriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backwardPage.setOnClickListener {
            intent = Intent(this@WriteActivity, HomeActivity::class.java)
