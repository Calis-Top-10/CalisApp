...
class WriteLanjut : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_write_lanjut)
        ...
        backwardPage?.setOnClickListener{
            intent = Intent(this@WriteLanjut, WriteActivity::class.java)
        ...
        undoBtn.setOnClickListener {
            if (paint.isTouch()) {
                ...
                Toast.makeText(this@WriteLanjut, "Jawaban Kosong!!", Toast.LENGTH_LONG).show()
            }
        }
        ...
        saveBtn.setOnClickListener {
            if (paint.isTouch()) {
                Toast.makeText(this@WriteLanjut, "Jawaban Benar!!", Toast.LENGTH_LONG).show()
            }else{
                Toast.makeText(this@WriteLanjut, "Jawaban Kosong!!", Toast.LENGTH_LONG).show()
            }
        }
