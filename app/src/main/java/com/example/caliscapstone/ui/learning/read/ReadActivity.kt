package com.example.caliscapstone.ui.learning.read

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.ImageView
import com.example.caliscapstone.ui.learning.read.level.ReadDasar
import com.example.caliscapstone.ui.learning.read.level.ReadLanjut
import com.example.caliscapstone.ui.learning.read.level.ReadMenengah
...
class ReadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backwardPage.setOnClickListener {
            intent = Intent(this@ReadActivity, HomeActivity::class.java)
