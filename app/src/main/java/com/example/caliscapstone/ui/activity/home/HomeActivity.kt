package com.example.caliscapstone.ui.activity.home
...
import com.example.caliscapstone.ui.activity.learning.calculate.CalculateActivity
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingPage.setOnClickListener {
            intent = Intent(this@HomeActivity, DummyHome::class.java)
            startActivity(intent)
        }
