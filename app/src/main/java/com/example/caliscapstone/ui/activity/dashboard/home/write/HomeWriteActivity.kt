...
import com.example.caliscapstone.ui.adapter.write.WriteTypeAdapter
...
class HomeWriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hoverHome.setOnClickListener {
            val intentToLesson = Intent(this@HomeWriteActivity, WriteActivity::class.java)
    ...
    private fun getJSONFromAssets(): String? {
        ...
        try {
            val lessonsJSONFile = assets.open("soal_tulis.jsonc")
    ...
    private fun showRecyclerList() {
        ...
        val itemAdapter = WriteTypeAdapter(this, lessonsList)
        // adapter instance is set to the recyclerview to inflate the items.
        rvLessonsList.adapter = itemAdapter
        itemAdapter.setOnItemClickCallback(object : WriteTypeAdapter.OnItemClickCallback {
            override fun onItemClicked(data: Lesson) {
                val intentToDetail = Intent(this@HomeWriteActivity, LevelWriteActivity::class.java)
