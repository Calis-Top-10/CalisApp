...
import com.example.caliscapstone.ui.activity.dashboard.home.calculate.level.CalculateLanjut
import com.example.caliscapstone.ui.activity.dashboard.home.calculate.level.CalculateMenengah
...
class CalculateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backwardPage.setOnClickListener {
            intent = Intent(this@CalculateActivity, HomeCalculateActivity::class.java)
