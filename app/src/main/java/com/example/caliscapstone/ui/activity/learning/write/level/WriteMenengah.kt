package com.example.caliscapstone.ui.activity.learning.write.level
...
class WriteMenengah : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_write_menengah)
        ...
        backwardPage?.setOnClickListener{
            intent = Intent(this@WriteMenengah, WriteActivity::class.java)
        ...
        undoBtn.setOnClickListener {
            if (paint.isTouch()) {
                ...
                Toast.makeText(this@WriteMenengah, "Jawaban Kosong!!", Toast.LENGTH_LONG).show()
            }
        }
        ...
        saveBtn.setOnClickListener {
            if (paint.isTouch()) {
                Toast.makeText(this@WriteMenengah, "Jawaban Benar!!", Toast.LENGTH_LONG).show()
            }else{
                Toast.makeText(this@WriteMenengah, "Jawaban Kosong!!", Toast.LENGTH_LONG).show()
            }
        }
