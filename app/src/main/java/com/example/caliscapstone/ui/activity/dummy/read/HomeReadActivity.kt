...
import com.example.caliscapstone.ui.adapter.read.ReadLevelAdapter
import com.example.caliscapstone.ui.adapter.read.ReadTypeAdapter
...
class HomeReadActivity : AppCompatActivity() {
    ...
    private fun getJSONFromAssets(): String? {
        ...
        try {
            val lessonsJSONFile = assets.open("soal_baca.jsonc")
    ...
    private fun showRecyclerList() {
        ...
        val itemAdapter = ReadTypeAdapter(this, lessonsList)
