...
import com.example.caliscapstone.ui.activity.dashboard.home.calculate.response.ResponseCalculate
import com.example.caliscapstone.ui.activity.login.LoginActivity
import com.example.caliscapstone.ui.activity.dashboard.setting.dummy.HayoActivity
...
class HomeCalculateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_home_calculate)
        ...
        hoverHome.setOnClickListener {
            val intentToLesson = Intent(this@HomeCalculateActivity, CalculateActivity::class.java)
        ...
        try {
            ...
            val users = Gson().fromJson(jsonString, ResponseCalculate::class.java)
    ...
    private fun showRecyclerList() {
        ...
        itemAdapter.setOnItemClickCallback(object : CalculateTypeAdapter.OnItemClickCallback {
            override fun onItemClicked(data: Lesson) {
                val intentToDetail = Intent(this@HomeCalculateActivity, HayoActivity::class.java)
